...
export const AdCard: React.FC<AdCardProps> = ({ad, user, onShowAnalytics, onDelete}) => {
    ...
    return (
        <div style={{
            ...
            e.currentTarget.style.borderColor = '#2b7dd4';
            e.currentTarget.style.boxShadow = '0 10px 20px rgba(43, 125, 212, 0.15)';
        }} onMouseLeave={(e) => {
            ...
            <div style={{padding: '16px'}}>
                ...
                <div style={{
                    ...
                    borderRadius: '6px',
                    marginBottom: '12px',
                    borderLeft: '3px solid #2b7dd4'
                }}>
                    <p style={{fontSize: '18px', fontWeight: 'bold', color: '#2b79cc', margin: 0}}>
            ...
            <div style={{
                ...
                {user?.accountType === 'PREMIUM' && isOwner && (
                    <button onClick={() => onShowAnalytics(ad)} style={{
                        flex: 1,
                        padding: '8px 12px',
                ...
                {isOwner && (
                    <button onClick={() => onDelete(adId)} style={{
                        ...
                        transition: 'all 0.2s'
                            ...
                            onMouseLeave={(e) => e.currentTarget.style.opacity = '1'}>Видалити</button>
                )}
            </div>
        </div>
    );
